...
class CartPoleSwingUpHarderEnv(gym.Env):
    ...
    def _render(self, mode='human', close=False, override_state=None):
        ...
        if self.viewer is None:
            ...
            self.cart = rendering.FilledPolygon([(l, b), (l, t), (r, t), (r,
                                                                          b)])
            ...
            self.pole = rendering.FilledPolygon([(l, b), (l, t), (r, t), (r,
                                                                          b)])
            ...
            self.dream_axle = rendering.make_circle(
                polewidth / 2, filled=False)
            ...
            # Make another circle on the top of the pole
            self.dream_pole_bob = rendering.make_circle(
                polewidth / 2, filled=False)
            ...
            self.track = rendering.Line(
                (screen_width/2 - self.x_threshold*scale,carty - \
                 cartheight/2 - cartheight/4),
                (screen_width/2 + self.x_threshold*scale,carty - \
                 cartheight/2 - cartheight/4))
