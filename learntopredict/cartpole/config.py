...
Game = namedtuple('Game', [
    ...
    'activation', 'noise_bias', 'output_noise', 'experimental_mode'
])
...
cartpole_swingup_harder = Game(
    env_name='CartPoleSwingUpHarder',
    input_size=5,
    output_size=1,
    time_factor=0,
    layers=[10, 0],
...
dream_cartpole_swingup = Game(
    env_name='DreamCartPoleSwingUp',
    input_size=5,
    output_size=1,
    time_factor=0,
    layers=[10, 0],
